...
def pagination(request,query_output):
  page=request.args.get('page',1,type=int)
  start=(page-1)*QUESTIONS_PER_PAGE 
  end=start+10
  questions_formated=[question.format() for question in query_output]
  ...
  def create_question():
    ...
    if(search_term):
      ...
      try:
        ...
        questions_formated=[question.format() for question in Selections]
        current_questions=questions_formated[start:end]
        return jsonify({
        'Success':True,
        'created':question.id,
