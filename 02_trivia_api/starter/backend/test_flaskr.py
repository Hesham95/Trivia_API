...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres:///trivia_test"
        setup_db(self.app, self.database_path)
        self.new_question = {
            'question': 'Which club win with africa cup for 2020?',
            'answer': 'Al-Ahly',
            'difficulty': 3,
            'category': '6'
        }
    ...
    def test_delete_question_by_id(self):
        ...
        question=Question(question=self.new_question['question'],answer=
            self.new_question['answer'],category=self.new_question['category'],difficulty=self.new_question['difficulty'])
        question.insert()
        ...
        self.assertTrue(len(questions_before_delete) - len(questions_after) == 1)
